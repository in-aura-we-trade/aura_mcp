...
9. `prepare_trade`, `prepare_place_limit_orders`, and `prepare_limit_order` can omit common execution knobs; Aura MCP fills slippage, tip, fee, processors, durable nonce, slot latency, and price-impact defaults.
